...
{
    [ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(MAUIRefactorKitCodeFixProvider)), Shared]
    public class MAUIRefactorKitCodeFixProvider : CodeFixProvider
    {

        public sealed override ImmutableArray<string> FixableDiagnosticIds
        {
            get { return ImmutableArray.Create(MAUIRefactorKitAnalyzer.DiagnosticId); }
        }
        ...
        public override async Task RegisterCodeFixesAsync(CodeFixContext context)
        {
            ...
            context.RegisterCodeFix(
                CodeAction.Create(
                    ...
                    nameof(MAUIRefactorKitAnalyzer)),
                diagnostic);
        }
                ...
                foreach (var statement in setter.Body.Statements)
                {
                        ...
                        assignExpr.Left is IdentifierNameSyntax leftId)
                    {
                        backingFieldName = leftId.Identifier.Text;
                            ...
                            idName2.Identifier.Text == MAUIRefactorKitAnalyzer.SetProperty &&
                    ...
                    if (statement is ExpressionStatementSyntax exprStmt3 &&
                        ...
                        idName.Identifier.Text == MAUIRefactorKitAnalyzer.OnPropertyChanged)
                    {
